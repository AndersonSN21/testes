...
abstract class AbstractClassesThat<CONJUNCTION> implements ClassesThat<CONJUNCTION> {
    protected abstract CONJUNCTION givenWith(DescribedPredicate<? super JavaClass> predicate);
